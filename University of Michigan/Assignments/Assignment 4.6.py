...
def computepay():   #här ska det (inte)nog vara pay och overtime inom ()
    if h <= 40:
        pay = r * h
        return (pay)
    if h > 40:
...
print("Pay", p)
#print("Pay", p)
#print(computepay("fr"), "Michael")



#p = computepay(10,20) ska på nåt sätt vara pay och overtime när de skickas tillbaka från funktionen. Här är jag nu
